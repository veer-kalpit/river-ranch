...
const AboutUs = () => {
  return (
    <section className="about-us flex flex-col items-center justify-center w-full h-auto max-w-[1920px] bg-[#205781] px-4 py-16 text-center">
      ...
      <p className="mt-6 md:mt-10 font-cormorant font-semibold text-2xl md:text-4xl lg:text-5xl leading-normal text-white max-w-[90%] md:max-w-[1185px] capitalize">
        ...
        peaceful setting and refined charm, it&apos;s perfect for weekend getaways,
