...
const Home = ({ onRenderComplete }) => {
  ...
  // for pegion animation

  useGSAP(() => {
    if (!pegionRef.current) return;

    gsap.set(pegionRef.current, {
      x: "-15vw",
    });

    gsap.to(pegionRef.current, {
      keyframes: [
        { x: "-0vw", y: "28vh", duration: 1 }, // enter
        { x: "15vw", y: "25vh", duration: 0.9 }, // gentle rise
        { x: "30vw", y: "32vh", duration: 0.8 }, // dip
        { x: "45vw", y: "23vh", duration: 0.9 }, // rise
        { x: "60vw", y: "33vh", duration: 0.8 }, // dip
        { x: "75vw", y: "21vh", duration: 0.9 }, // higher rise
        { x: "90vw", y: "30vh", duration: 0.8 }, // dip
        { x: "105vw", y: "24vh", duration: 1 }, // near end
        { x: "115vw", y: "20vh", duration: 1 }, // fly off
      ],
    });
  }, []);
